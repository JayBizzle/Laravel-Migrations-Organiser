...
class MigrateFlattenTest extends TestCase
{
    ...
    public function test_flatten_moves_migrations_back_to_base_folder()
    {
        ...
        $this->artisan('migrate:flatten', ['--force' => true])
    ...
    public function test_flatten_deletes_subdirectories_with_force_flag()
    {
        mkdir($this->migrationPath.'/2024/03', 0775, true);
        file_put_contents($this->migrationPath.'/2024/03/2024_03_26_000000_create_users_table.php', '<?php');
    ...
    public function test_flatten_reports_when_no_migrations_to_move()
    {
        $this->artisan('migrate:flatten', ['--force' => true])
    ...
    public function test_flatten_prompts_for_cleanup_without_force()
    {
        mkdir($this->migrationPath.'/2024/03', 0775, true);
        file_put_contents($this->migrationPath.'/2024/03/2024_03_26_000000_create_users_table.php', '<?php');

        $this->artisan('migrate:flatten')
